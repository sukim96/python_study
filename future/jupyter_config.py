...
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$uOZVLftzj1ETjrh4obPkAA$ZFt9OUnpMj1KGGaU3PThzAz6sC9AxPNEdn+QwcgTcY0'
...
#  Choices: any of ['sha224', 'sha1', 'md5', 'sha512', 'sha384', 'blake2b', 'blake2s', 'sha3_512', 'sha3_384', 'sha3_256', 'sha3_224', 'sha256']
#  Default: 'sha256'
